...
var _cities = {
    cityInfo : {
        ...
        '四川':['成都','广元','绵阳','德阳','南充','广安','遂宁','内江','乐山','自贡','泸州','宜宾','攀枝花','巴中','达川','资阳','眉山','雅安','阿坝','甘孜','凉山'],
        ...
        '香港':['香港'],
        '澳门':['澳门'],
        '台湾':['台北','台东','台中','台南','连江','高雄','花莲','嘉义','基隆','金门','苗栗','南投','澎湖','屏东','桃园','新北','新竹','宜兰','云林','彰化']
    },
